...
Per SRS section 3.2, the desktop/web experience is **limited for money lockdowns** - those
...
- **Admin console** - manage users, data, and system settings (SRS section 2.3 admin class).
...
## Cross-browser support (SRS section 5, NFR)
