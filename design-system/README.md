...
The glyphs below are shown as the literal characters, not code points: they are
the icon set the product actually renders, so this table is the reference for
them and has to look like what you will see on screen.
